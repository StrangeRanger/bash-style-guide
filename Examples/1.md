...
################################################################################
#
# THIS SCRIPT IS FROM THE BULLETBOT PROJECT THAT CAN BE FOUND HERE:
# https://github.com/CodeBullet-Community/BulletBot/blob/master/linux-master-installer.sh
# NOTE: IN THIS SCRIPT, LOCAL ISN'T USED FOR VARIABLES IN FUNCTIONS, DUE TO ALL
# VARIBALES BEING USED OUTSIDE OF THE FUNCTION
#
